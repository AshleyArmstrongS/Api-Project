...
async function signUp(parent, args) {
  ...
  return {code: 201, success: true, message: "Signed Up successfully.", token: userToken, farmer: newFarmer}
}
async function login(parent, args) {
  ...
  return {code: 200, success: true, message: "Logged in successfully.", token: userToken, farmer: loggingInFarmer}
}
//Animal Mutations
async function createAnimal(parent, args, context){
  ...
  if (!valid) {
   ...
   return {code: 201, success: true, message: "Animal created successful", animal: newAnimal}
}
async function updateAnimal(parent, args){
  ...
  return {code: 200, success: true, message: "Animal updated successful", animal: editedAnimal}
}
...
async function deleteAnimal(parent, args, context){
  ...
  return {code: 200, success: true, message: "Animal deleted successful", animal: animalToDelete}
}
// Group Mutations
async function createGroup(parent, args, context) {
  ...
  return {code: 201, success: true, message: "Group created successful", group: newGroup}
}
 async function updateGroup(parent, args, context){
   ...
   const valid = await Group.findByIdAndUpdate({"_id" : args.id},
    ...
    return{code: 200, success: true, message: "Animal updated successful", group: editedGroup}
}
//Medication Queries
...
return {code: 201, success: true, message: "Medication created successful", medication: newMedication}
}
async function updateMedication(parent, args){
  ...
  return {code: 200, success: true, message: "Animal updated successful", medication: updatedMedication}
}
